...
public class IndexSender implements ISender {
    ...
    private void level2RowData(MysqlRowData rowData) {
        if (Constant.AD_PLAN_TABLE_INFO.TABLE_NAME.equals(rowData.getTableName())) {
            ...
            rowData.getFieldValueMap().forEach(fieldValueMap -> {
    ...
    private void level3RowData(MysqlRowData rowData) {
        if (Constant.AD_UNIT_TABLE_INFO.TABLE_NAME.equals(rowData.getTableName())) {
        ...
        } else if (Constant.AD_CREATIVE_UNIT_TABLE_INFO.TABLE_NAME.equals(rowData.getTableName())) {
